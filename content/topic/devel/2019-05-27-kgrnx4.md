...
Anaconda 团队已经创建了一个 "[R Essentials](https://anaconda.org/r/r-" 把 IRKernel 和数据科学分析中最常用的超过 80 个 R 包捆绑在了一起，这些包包括：**dplyr、shiny、ggplot2、tidyr、caret** 和 **nnet**。
...
Selection: 
Warning message:
In doTryCatch(r, name, parentenv, handler) :
...
组织成和副幻灯片：<br />![](https://qiniu.bioinit.com/yuque/0/2019/png/126032/1558917805323-5350a60a-2c11-4f42-aa34-c1d7fb3359db.png#align=left&display=inline&height=1013&originHeight=1013&originWidth=1920&size=0&status=done&width=1920)
